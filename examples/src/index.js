  ...
  return(
    ...
    <section className="home">
      <div className="container">
        <a
          className="logo"
          href="https://scaleflex.github.io/react-cloudimage-responsive-blur-hash/">
          React Cloudimage Responsive
        </a>
        <p>(Blur Hash version)</p>
        <div className="reference-buttons">
          <a className="github-button" target="_blank"
             href="https://github.com/Scaleflex/react-cloudimage-responsive-blur-hash/subscription" data-icon="octicon-eye"
             aria-label="Watch Scaleflex/react-cloudimage-responsive-blur-hash on GitHub">Watch</a>
          <a className="github-button" target="_blank"
             href="https://github.com/Scaleflex/react-cloudimage-responsive-blur-hash"
             data-icon="octicon-star" aria-label="Star Scaleflex/react-cloudimage-responsive-blur-hash on GitHub">Star</a>
          <a className="github-button" target="_blank"
             href="https://github.com/Scaleflex/react-cloudimage-responsive-blur-hash/fork"
             data-icon="octicon-repo-forked"
             aria-label="Fork Scaleflex/react-cloudimage-responsive-blur-hash on GitHub">Fork</a>
          <a className="twitter-share-button btn btn-info" target="_blank"
             href="https://twitter.com/intent/tweet?text=Responsive%20images,%20now%20easier%20than%20ever&url=https://scaleflex.github.io/react-cloudimage-responsive-blur-hash/&via=cloudimage&hashtags=images,cloudimage,responsive_images,lazy_loading,web_acceleration,image_optimization,image_CDN,image_CDNwebp,jpeg_xr,jpg_optimization,image_resizing_and_CDN,cropresize">
            <i> </i>
            <span>Tweet</span>
          </a>
        </div>
        ...
        <h2>
          ...
          across
          the World in your site for all devices. The plugin supports <strong>lazy load</strong> with <strong>blur
          hash</strong> placeholder.
        </h2>
      ...
      <a href="https://github.com/scaleflex/react-cloudimage-responsive-blur-hash" target="_blank">
        <img
    ...
    <section className="container-box-wrapper" style={{ margin: 0 }}>
      <ContainerBox/>
      <Img src={images[0].src} ratio={images[0].ratio} blurhash={images[0].blur_hash}/>
    </section>
    ...
    <div style={{ background: '#fff' }}>
      <section className="container ready-to-start">
        ...
        <ul>
          ...
          <li>Very compact representation of a placeholder for an image using <strong>blur-hash</strong> string</li>
        ...
        <div className="row images-in-columns">
          <div className="col-12">
            <div className="container-box-wrapper">
              <ContainerBox/>
              <Img src={images[8].src} ratio={images[8].ratio} blurhash={images[8].blur_hash}/>
            </div>
          </div>
          ...
          {images.slice(1, 7).map((image, index) => (
            <div key={index} className="col-6">
              <div className="container-box-wrapper">
                <ContainerBox/>
                <Img src={image.src} ratio={image.ratio} blurhash={image.blur_hash}/>
...
>...</BackgroundImg>`}</SyntaxHighlighter>
      ...
      >
        <div style={{ padding: 40, background: 'rgba(0,0,0,0.3)' }}>
          <div className="container" >
      ...
      <div id="js-version-box">
        <div className="action-wrapper first-action">
          ...
          <figure className="highlight">
            <pre><code className="javascript">npm install --save react-cloudimage-responsive-blur-hash</code></pre>
          </figure>
        </div>
...
render(<App />, document.body);`}</SyntaxHighlighter>
          ...
          <div className="action-wrapper forth-action">
            <p>
              …and you're done!{' '}
              <a href="https://github.com/scaleflex/react-cloudimage-responsive-blur-hash#table-of-contents"
                 target="_blank">{' '}
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="footer-menu col-sm-3">
              <ul>
                <li><a href="https://github.com/scaleflex/react-cloudimage-responsive-blur-hash" target="_blank">View
                  GitHub</a></li>
                <li><a href="https://github.com/scaleflex/react-cloudimage-responsive-blur-hash/issues" target="_blank">Current
                  Issues</a>
                </li>
                <li><a href="https://github.com/scaleflex/react-cloudimage-responsive-blur-hash#table-of-contents"
    ...
    <div id="device-pixel-ratio" className="device-pixel-ratio">
      ...
      <div className="window-width-box"><span>{innerWidth} px</span></div>
    </div>
